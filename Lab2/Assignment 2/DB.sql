...
select STUDENT.sname , STUDENT.major,COURSE.cname, FACULTY.fName   from STUDENT inner join ENROLLED on 
STUDENT.snum = ENROLLED.snum inner join COURSE ON
COURSE.cnum=ENROLLED.cnum inner join FACULTY on COURSE.Fid=FACULTY.Fid where STUDENT.major  = 'CSE' and COURSE.cname='Database';
